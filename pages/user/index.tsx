    ...
    <div>
      ...
      <div className="w-full flex justify-center gap-5 px-5 py-5">
          ...
          <div className="flex justify-center items-center flex-col py-5 gap-5">
            {announcements.reverse().map((announcement, index) => (
              <div className="bg-customWhite p-5 shadow-lg rounded-md border">
                <h1 className="text-3xl font-SegoeUI font-bold capitalize">{announcement.title}</h1>
                <h1 className="font-SegoeUI ">{beautifyDate(announcement.date)}</h1>
                <div className=" h-80 overflow-hidden flex justify-center items-center">
                <img src={announcement.image} alt="" className="min-w-2/3 max-w-2/3 w-2/3 mx-auto"/>
                </div>
        ...
        <div className="w-1/3 mt-5    bg-white rounded-lg p-5">
          <h1 className="font-SegoeUI font-bold text-primary text-xl drop-shadow-lg border-b border-gray-700">Important Announcements</h1>
        </div>
      </div>
    </div>
  );
